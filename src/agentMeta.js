...
export const PERSONA_META = [
  {
    ...
    initial: "O",
    maxTurns: 15,
    profileUrl: `${SITE}/pers-omar-business-lunch-v3.html`,
  ...
  },
  {
    ...
    initial: "G",
    maxTurns: 15,
    profileUrl: `${SITE}/pers-grace-business-lunch-v3.html`,
    journeyUrl: `${SITE}/journey-map-business-lunch-v3.html`,
    journeyLabel: "Business Lunch journey map",
    journeyStages: BUSINESS_LUNCH_STAGES,
    sources: [
  ...
  },
  {
    ...
    initial: "M",
    maxTurns: 15,
    profileUrl: `${SITE}/pers-mateo-late-night-foodie-v3.html`,
  ...
  },
  {
    ...
    initial: "D",
    maxTurns: 15,
    profileUrl: `${SITE}/pers-diego-franchisee-v3.html`,
    journeyUrl: null,
    journeyLabel: null,
    journeyStages: [],
    sources: [
  ...
  },
  {
    ...
    initial: "T",
    maxTurns: 15,
    profileUrl: `${SITE}/pers-tyler-everyday-20s-v3.html`,
    journeyUrl: null,
    journeyLabel: null,
    journeyStages: [],
    sources: [
