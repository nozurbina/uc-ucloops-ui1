...
import { PERSONA_MASTER_TEMPLATE, SHARED_SKILLS } from "./templates.generated.js";

// The behaviour spec every persona shares: the Persona Master Template plus the
// shared skills available to all ucLoops agents. Both are compiled from the
// markdown in src/ucLoops-templates/ by scripts/build-templates.mjs, so those
// .md files stay the single source of truth.
const SHARED_PERSONA_TEMPLATE = PERSONA_MASTER_TEMPLATE + `
